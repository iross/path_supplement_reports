...
through the NAIRR Pilot Program. We trained \todo{update numbers}21 variants of a METL
protein language model, consuming over \todo{update numbers}5,300 GPU hours on 6 different GPU
...
\todo{Summarize global protein model experiment as well}
...
\todo{What about the refresh?}

\subsection{Access Point}\label{access-point}

We used the OSPool access point
\href{http://ap40.uw.osg-htc.org}{\texttt{ap40.uw.osg-htc.org}} for all
training jobs targeting either OSPool or NAIRR resources. The second round of
experiments included baseline runs run within CHTC, \texttt{ap2002}.
There is no special configuration needed on the shared access points to
...
script, in order to: \todo{update since it's more like a library and maybe a bit more usable now.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{./images/DAG}
\label{fig:dag}
...
% ============================================================
\section{Experiment 1: Initial METL Model Training}\label{experiment1}
% ============================================================

\subsection{Model configuration}\label{model-config-exp1}

An initial training model (uuid 861e7e66) was trained, alternating between
Expanse and Delta annexes. \todo{Describe the model architecture and configuration used in Experiment 1 (the misconfigured small-model arguments with global dataset)}
...
\todo{Lots of updates in here...this was all the old model.  }
...
% ============================================================
\section{Experiment 2: Global Protein Model Training}\label{experiment2}
% ============================================================

During the course of the first experiment, it was discovered that the model
...
comparable to the existing published versions. A second round of training was
conducted utilizing a larger model architecture more suited to the ``global''
scope of the training data and consistent with the published models. The
resources, utilities, and strategies implemented in the initial experiment were
heavily re-used for this second experiment.

\subsection{Model configuration}\label{model-config-exp2}
\todo{Describe the global model architecture and configuration used in Experiment 2}

\subsection{Results}\label{results-global}

\subsubsection{Training process}\label{results-training-global}
\todo{Describe training process results for the global model experiment}

\subsubsection{Evaluation}\label{results-evaluation-global}
\todo{Describe evaluation results for the global model experiment}
...
\todo{Summarize conclusions from the global model experiment}
...
\todo{Update with ongoing annex work summary}
