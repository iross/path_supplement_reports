...
for improvement in the HTCondor software, especially in its Directed Acyclic Graph manager (DAGMan). While programtically creating a DAG in this fashion
...
being heavily re-used for this second experiment. As of 2025-09-15, the second
round of training is underway, with 92 completed epochs of trianing across 20
different runs.

\section{Appendix}\label{section-1}
\subsection{Woes and Findings}
\subsubsection{Failure to automate annex creation}
...
Although many of these sites are trusted and well-implented within the OSPool
